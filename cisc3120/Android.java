...
/**
 * Android class creates an Android object which is an android character with a type of thunder
 * @author Erii Sugimoto.
 */
public class Android extends AbstractCharacter implements Character{

    private final String ELEMENT_TYPE = "thunder";
    private final String CHARACTER_TYPE = "android";

    /**
     * This constructor sets a new Android's element, character type, health, attack,
    ...
    public void addBonusHealth() {
        ...
        for(int i = 0; i<party.size(); i++)
            if(party.get(i).getClass().getName().equalsIgnoreCase("Engineer"));
