...
/**
 * Mariner class creates a Mariner object which is a mariner character with a type of water
 * @author Erii Sugimoto.
 */
public class Mariner extends AbstractCharacter {

    private final String ELEMENT_TYPE = "water";
    private final String CHARACTER_TYPE = "mariner";

    /**
     * This constructor sets a new Mariner's element, character type, health, attack,
    ...
    public void addBonusHealth() {
        ...
        for(int i = 0; i<party.size(); i++)
            if(party.get(i).getClass().getName().equalsIgnoreCase("Healer"));
