...
/**
 * Swordsman class creates a swordsman object
 * @author Erii Sugimoto.
 */
public class Swordsman extends AbstractCharacter implements Character{
    private final String ELEMENT_TYPE = "earth";
    private final String CHARACTER_TYPE = "swordsman";

    /**
     * This constructor sets a new Swordsman's element, character type, health, attack,
    ...
    public void addBonusHealth() {
        ...
        for (int i = 0; i < party.size(); i++)
            if (party.get(i).getClass().getName().equalsIgnoreCase("Beastmaster")) ;
    ...
    public void addBonusSp() {
        for (int i = 0; i < party.size(); i++) {
            ...
            if (className.equalsIgnoreCase("Soldier") || className.equalsIgnoreCase("Commander")) ;
