...
/**
 * Soldier class creates an Soldier object which is an android character with a type of thunder
 * @author Erii Sugimoto.
 */
public class Soldier extends AbstractCharacter {

    private final String ELEMENT_TYPE = "fire";
    private final String CHARACTER_TYPE = "soldier";

    /**
     * This constructor sets a new Soldier's element, character type, health, attack,
    ...
    public void addBonusHealth() {
        ...
        for(int i = 0; i<party.size(); i++)
            if(party.get(i).getClass().getName().equalsIgnoreCase("Commander"));
