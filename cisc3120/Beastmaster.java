...
/**
 * Beastmaster class creates a beastmaster object
 * @author Erii Sugimoto.
 */
public class Beastmaster extends AbstractCharacter {

    private final String ELEMENT_TYPE = "earth";
    private final String CHARACTER_TYPE = "beastmaster";

    /**
     * This constructor sets a new Beastmaster's element, character type, health, attack,
    ...
    public void addBonusHealth() {
        ...
        for (int i = 0; i < party.size(); i++)
            if (party.get(i).getClass().getName().equalsIgnoreCase("Swordsman")) ;
